...
function instance($$self, $$props, $$invalidate) {
  ...
  return [visible, message, option, positionClass, setDefault, show, click_handler];
}
class App extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance, create_fragment, safe_not_equal, { setDefault: 4, show: 5 });
  }
  get setDefault() {
    return this.$$.ctx[4];
  }
